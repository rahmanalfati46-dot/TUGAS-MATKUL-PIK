...
bank_soal = {
    "GLBB": [
        ...
        {"soal":"Rumus kecepatan pada GLBB adalah ...","opsi":["v = s/t","v = v₀ + at","v = at²","v = m a"],"jawaban":"v = v₀ + at","penjelasan":"Kecepatan GLBB berubah karena adanya percepatan."},
        {"soal":"Rumus posisi GLBB adalah ...","opsi":["s = v t","s = v₀ t + ½ a t²","s = at²","s = m a t"],"jawaban":"s = v₀ t + ½ a t²","penjelasan":"Posisi berubah sesuai rumus GLBB."},
        {"soal":"Satuan percepatan dalam SI adalah ...","opsi":["m","m/s","m/s²","kg"],"jawaban":"m/s²","penjelasan":"Percepatan adalah perubahan kecepatan per satuan waktu."},
        ...
        {"soal":"Grafik v–t pada GLBB berbentuk ...","opsi":["garis lurus","parabola","lingkaran","hiperbola"],"jawaban":"garis lurus","penjelasan":"Kecepatan berubah linier terhadap waktu."},
        {"soal":"Kecepatan awal mobil 20 m/s, percepatan 2 m/s², kecepatan setelah 5 s adalah ...","opsi":["30 m/s","40 m/s","25 m/s","35 m/s"],"jawaban":"30 m/s","penjelasan":"v = v₀ + at → 20 + 2*5 = 30 m/s."},
        {"soal":"Sebuah benda bergerak dengan GLBB, percepatan 3 m/s², waktu 4 s, jarak ditempuh ...","opsi":["24 m","32 m","40 m","36 m"],"jawaban":"32 m","penjelasan":"s = v₀ t + ½ a t² → 0 + 0.5*3*16=24 m (jika v₀=0, periksa soal)."},
        ...
        {"soal":"Satuan kecepatan dalam SI adalah ...","opsi":["m","m/s","m/s²","N"],"jawaban":"m/s","penjelasan":"Kecepatan = jarak/waktu."}
    ],
    ...
    "Hukum Newton": [
        ...
        {"soal":"Massa benda 5 kg, percepatan 2 m/s², gaya yang bekerja ...","opsi":["5 N","10 N","7 N","12 N"],"jawaban":"10 N","penjelasan":"F = m*a → 5*2=10 N."},
        ...
        {"soal":"Benda yang bergerak lurus dengan kecepatan konstan mengalami gaya ...","opsi":["nol","konstan","bertambah","berkurang"],"jawaban":"nol","penjelasan":"Newton I, tidak ada percepatan → gaya total nol."},
    ...
    "Energi": [
        {"soal":"Rumus energi kinetik adalah ...","opsi":["mgh","½mv²","Fs","IR"],"jawaban":"½mv²","penjelasan":"Energi kinetik dimiliki benda bergerak."},
        {"soal":"Rumus energi potensial gravitasi ...","opsi":["mgh","½mv²","Fs","IR"],"jawaban":"mgh","penjelasan":"Energi potensial = m*g*h."},
        ...
        {"soal":"Energi kinetik meningkat saat ...","opsi":["massa bertambah","kecepatan bertambah","massa dan kecepatan bertambah","kecepatan berkurang"],"jawaban":"kecepatan bertambah","penjelasan":"EK = ½ m v², kecepatan dominan."},
        ...
        {"soal":"Energi kinetik benda 2 kg, v=3 m/s ...","opsi":["9 J","6 J","12 J","18 J"],"jawaban":"9 J","penjelasan":"EK=½*2*3²=9 J."},
        {"soal":"Energi potensial benda 3 kg, h=4 m, g=10 m/s² ...","opsi":["120 J","100 J","140 J","60 J"],"jawaban":"120 J","penjelasan":"EP = m*g*h = 3*10*4 =120 J."},
        {"soal":"Energi mekanik adalah ...","opsi":["EK","EP","EK+EP","EK-EP"],"jawaban":"EK+EP","penjelasan":"Energi mekanik = EK + EP."}
    ],

    "Hukum Ohm": [
        {"soal":"Rumus Hukum Ohm adalah ...","opsi":["V = IR","P = VI","Q = mcΔT","W = Fs"],"jawaban":"V = IR","penjelasan":"Tegangan berbanding lurus dengan arus dan hambatan."},
        ...
        {"soal":"Jika arus 2 A dan R=5 Ω, tegangan ...","opsi":["5 V","10 V","8 V","15 V"],"jawaban":"10 V","penjelasan":"V=I*R=2*5=10 V."},
        ...
        {"soal":"Jika R=10 Ω, V=20 V, I ...","opsi":["2 A","0,5 A","20 A","10 A"],"jawaban":"2 A","penjelasan":"I = V/R = 20/10 = 2 A."}
    ],

    "Kalor": [
        {"soal":"Rumus kalor untuk perubahan suhu adalah ...","opsi":["Q = mcΔT","Q = mgh","Q = Fs","Q = IR"],"jawaban":"Q = mcΔT","penjelasan":"Kalor dipengaruhi massa, kalor jenis, dan perubahan suhu."},
        {"soal":"Satuan kalor dalam SI adalah ...","opsi":["Joule","Kalori","Watt","Newton"],"jawaban":"Joule","penjelasan":"Kalor diukur dalam Joule."},
        {"soal":"Kalor jenis air ...","opsi":["4186 J/kg°C","1000 J/kg°C","500 J/kg°C","2000 J/kg°C"],"jawaban":"4186 J/kg°C","penjelasan":"Nilai kalor jenis air."},
        {"soal":"Jika massa meningkat, Q ...","opsi":["bertambah","berkurang","tetap","nol"],"jawaban":"bertambah","penjelasan":"Q = m c ΔT."},
        {"soal":"Jika ΔT meningkat, Q ...","opsi":["bertambah","berkurang","tetap","nol"],"jawaban":"bertambah","penjelasan":"Q = m c ΔT."},
        {"soal":"Jika c meningkat, Q ...","opsi":["bertambah","berkurang","tetap","nol"],"jawaban":"bertambah","penjelasan":"Q = m c ΔT."},
    ...
    "Momentum": [
        ...
        {"soal":"Momentum awal 4 kg*m/s, bertambah 6 kg*m/s → total ...","opsi":["10 kg m/s","2 kg m/s","6 kg m/s","4 kg m/s"],"jawaban":"10 kg m/s","penjelasan":"Penjumlahan momentum vektor."},
        ...
        {"soal":"Benda diam momentum ...","opsi":["0","tidak nol","m*g","m*v"],"jawaban":"0","penjelasan":"v = 0 → p = 0."}
    ],

    "Usaha": [
        {"soal":"Rumus usaha adalah ...","opsi":["W = Fs","W = mv²","W = IR","W = mcΔT"],"jawaban":"W = Fs","penjelasan":"Usaha terjadi jika gaya menyebabkan perpindahan."},
        {"soal":"Satuan usaha ...","opsi":["Joule","Newton","Watt","Pascal"],"jawaban":"Joule","penjelasan":"Usaha diukur dalam Joule."},
        {"soal":"Jika perpindahan nol, usaha ...","opsi":["nol","besar","kecil","konstan"],"jawaban":"nol","penjelasan":"Tidak ada perpindahan → usaha nol."},
        {"soal":"Jika gaya tegak lurus perpindahan, usaha ...","opsi":["nol","besar","kecil","konstan"],"jawaban":"nol","penjelasan":"W = F cos θ, θ=90° → W=0."},
        ...
        {"soal":"Jika gaya 10 N, s = 5 m, θ=60° → W ...","opsi":["25 J","50 J","5 J","30 J"],"jawaban":"25 J","penjelasan":"W = F*s*cosθ = 10*5*0.5=25 J."},
    ]
        }
...
if not st.session_state.login:
    st.sidebar.header("🔑 Login Admin (Opsional)")
...
# =========================
    ...
    st.header("🎯 Latihan Fisika Interaktif")
    ...
    if st.session_state.nama_siswa == "":
        st.session_state.nama_siswa = st.text_input("Masukkan nama kamu:")
        if st.session_state.nama_siswa == "":
            st.warning("Silakan masukkan nama untuk memulai latihan.")
            st.stop()
    ...
    if st.session_state.quiz_index >= len(quiz):
        st.success(f"🎉 Latihan selesai! Skor kamu: {st.session_state.quiz_score}")
        ...
        # reset nama siswa agar bisa latihan berikutnya
        st.session_state.nama_siswa = ""
    else:
    ...
    if st.button("Login"):
        if username=="Dirma" and password=="Dirma123":
            ...
            if st.session_state.hasil_siswa:
                st.subheader("📊 Hasil Latihan Siswa")
